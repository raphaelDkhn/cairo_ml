...
fn sum_test() {
    ...
    vec1.append(i32 { inner: 23293_u32, sign: true });
    vec1.append(i32 { inner: 17752_u32, sign: false });
    vec1.append(i32 { inner: 32068_u32, sign: true });

    let mut vec2 = ArrayTrait::new();
    vec2.append(i32 { inner: 23533_u32, sign: false });
    vec2.append(i32 { inner: 24476_u32, sign: false });
    vec2.append(i32 { inner: 29585_u32, sign: true });
    ...
    let mut vec1 = ArrayTrait::new();
    vec1.append(i32 { inner: 3243_u32, sign: false });
    vec1.append(i32 { inner: 29084_u32, sign: true });
    vec1.append(i32 { inner: 16650_u32, sign: false });

    let mut vec2 = ArrayTrait::new();
    vec2.append(i32 { inner: 28891_u32, sign: false });
    vec2.append(i32 { inner: 11856_u32, sign: true });
    vec2.append(i32 { inner: 30435_u32, sign: true });
    ...
    let mut vec1 = ArrayTrait::new();
    vec1.append(i32 { inner: 32767_u32, sign: false });
    vec1.append(i32 { inner: 32768_u32, sign: true });
    vec1.append(i32 { inner: 0_u32, sign: false });

    let mut vec2 = ArrayTrait::new();
    vec2.append(i32 { inner: 10000_u32, sign: false });
    vec2.append(i32 { inner: 15000_u32, sign: true });
    vec2.append(i32 { inner: 16384_u32, sign: false });
...
fn find_min_test() {
    ...
    vec.append(i32 { inner: 80_u32, sign: false });
    vec.append(i32 { inner: 80_u32, sign: true });
    vec.append(i32 { inner: 50_u32, sign: false });
    vec.append(i32 { inner: 50_u32, sign: true });
    vec.append(i32 { inner: 25_u32, sign: false });
    vec.append(i32 { inner: 25_u32, sign: true });
    vec.append(i32 { inner: 127_u32, sign: false });
    vec.append(i32 { inner: 128_u32, sign: true });
