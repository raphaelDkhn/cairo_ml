...
//     let mut input_shape = MatrixShape { num_rows: 4_usize, num_cols: 4_usize };
...
// // assert(*result.at(0_usize).sign == false, 'result[1] -> positive');
// // assert(*result.at(2_usize).inner == 4_u32, 'result[2] == 4');
// // assert(*result.at(0_usize).sign == false, 'result[2] -> positive');
// // assert(*result.at(3_usize).inner == 5_u32, 'result[3] == 5');
// // assert(*result.at(0_usize).sign == false, 'result[3] -> positive');
// }
